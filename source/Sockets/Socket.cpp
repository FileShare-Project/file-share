...
** Last update Thu May 26 22:26:26 2022 Francois Michaut
**
...
namespace FileShare::Network {
    ...
    int Socket::read_buff(char *buff, std::size_t size) {
    ...
    int Socket::write(const std::string &buff) {
        return this->write(buff.data(), buff.size());
    }

    int Socket::write(const char *buff, std::size_t len) {
    ...
    int Socket::bind(int s_addr, int port) {
    ...
    void Socket::setNoBlock(bool val) {
